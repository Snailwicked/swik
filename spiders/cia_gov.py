...
url = "https://www.cia.gov/news-information/blog"
# https://www.cia.gov/news-information/press-releases-statements/2018-press-releases-statements/gina-haspel-assumes-role-of-acting-director-of-cia.html
html = requests.get(url).text
html_tree = etree.HTML(html)
herfs = html_tree.xpath("//span[@class= 'state-published url']//@href")
hrefs = ["https://www.cia.gov"+item for item in set(herfs)]
print(hrefs)
