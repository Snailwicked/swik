...
'''
https://www.dhs.gov/news-releases/press-releases?page={}
https://www.dhs.gov/blog?page=1
'''
from dateutil.parser import parse as date_parser
for i in range(2):
    url = "https://www.dhs.gov/blog?page={}".format(i)
    html = requests.get(url).text
    html_tree = etree.HTML(html)
    herfs = html_tree.xpath("//div[@class= 'field-content']//a//@href")
