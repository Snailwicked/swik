...
'''mysql 配置信息'''
MYSQL_CONFIG = "mysql://root:BlueSnail123!@101.132.113.50/spider_manage"
...
tf.flags.DEFINE_float('rmsprop_momentum', 0.99, 'Momentum.')

tf.flags.DEFINE_float('rmsprop_decay', 0.99, 'Decay term for RMSProp.')
...
tf.flags.DEFINE_float('learning_rate', 0.002,
