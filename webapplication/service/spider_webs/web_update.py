...
class WebUpdate:
    ...
    def update(self, data):
        ...
        try:
            remark = data['remark']
            sql = 'update webinfo set remark="{}" where id="{}"'.format(remark, id)
        except:
            pass
        try:
            sort = data['sort']
            sql = 'update webinfo set sort={}} where id="{}"'.format(sort, id)
        except:
            pass

        try:
            status = int(data['status'])
            sql = 'update webinfo set status={} where id="{}"'.format(status, id)
        except:
            pass
        try:
            checked = int(data['checked'])
            sql = 'update webinfo set checked={} where id="{}"'.format(checked, id)
        except:
            pass
        self.execute(sql)
