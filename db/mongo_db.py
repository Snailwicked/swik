...
class News_data():
    ...
    def select_by_date(self,parameter):
        page = int(parameter.get('page'))
        limit = int(parameter.get('limit'))
...
if __name__ == '__main__':
    ...
    # with open("dara.json","w+",encoding="utf-8") as fw:
    #     for i in range(1,130):
    #         paramters = {"page": i, "limit": 10, "keywords": ""}
    #         for item in con.select_by_paramters(paramters)['data']:
    #             monitor_words = ["cyber", "cybersecurity", "network security", "information security",
    #                              "Cyberspace policy", "Network vulnerability", "Cyber warfare", "Network attacks",
    #                              "cyber attack", "Data leakage", "Network  security standard", "guideline",
    #                              "Cyber security publication", "WikiLeaks", "steal secret", "Stealing technology",
    #                              "disclose a secret", "Confidential"]
    #             for words in monitor_words:
    ...
    temp = set()
    with open("dara.json","r+",encoding="utf-8") as fw:
        for item in fw.readlines():
            import json
            item = json.loads(item)
            if item["url"] not in temp:
                with open("data.json","a+",encoding="utf-8") as fr:
                    fr.writelines(json.dumps(item))
