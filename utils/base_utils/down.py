...
#         # rule = json.loads(self.parameters.get("rule"))
#         # capture = rule["filter_rule"]
#         # max_crawl = rule["page_size"]
#         # print(start_url,capture,max_crawl)
#         start_url = 'http://www.sohu.com/'
#         capture = 'http://www.sohu.com/a/\d+_\d+'
#         # start_url = "http://jiangsu.sina.com.cn/"
#         # capture = "http://jiangsu.sina.com.cn/news/m/"
#         max_crawl = 1
#         print(start_url,capture,max_crawl)
